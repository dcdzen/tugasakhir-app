document.getElementById("add-data-form").addEventListener("submit", async (e) => {
  ...
  try {
    const getResponse = await fetch("https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Mahasiswa");
    if (!getResponse.ok) {
    ...
    const postResponse = await fetch("https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Mahasiswa", {
      method: "POST",
      headers: {
