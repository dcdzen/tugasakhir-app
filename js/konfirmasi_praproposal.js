...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    const mahasiswaResponse = await fetch("https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Praproposal");
    ...
    if (!editData) {
      ...
      // Fetch Dosen Data
      const dosenResponse = await fetch("https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Dosen");
...
document.getElementById("add-data-form").addEventListener("submit", async (e) => {
  ...
  try {
    const response = await fetch(`https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Praproposal/NPM/${data.NPM}`, {
      method: "PUT",
      headers: {
    ...
    const responseDosen = await fetch(`https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Dosen/NIP/${user.NIP}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
