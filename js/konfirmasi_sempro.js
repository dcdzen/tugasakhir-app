...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    const mahasiswaResponse = await fetch("https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Sempro");
...
document.getElementById("konfirmasi-sempro").addEventListener("submit", async (e) => {
  ...
  try {
    const response = await fetch(`https://api.sheetbest.com/sheets/506f8840-a871-4430-b4c5-ff4c7926af72/tabs/Sempro/NPM/${data.NPM}`, {
      method: "PUT",
      headers: {
