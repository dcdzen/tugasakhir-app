...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const response = await fetch("https://api.sheetbest.com/sheets/a4e0b8ce-db68-4e5f-b0ff-d22f47fe3a0f/tabs/Praproposal");
    if (!response.ok) {
...
document.getElementById("add-data-form").addEventListener("submit", async (e) => {
  ...
  try {
    const getResponse = await fetch("https://api.sheetbest.com/sheets/a4e0b8ce-db68-4e5f-b0ff-d22f47fe3a0f/tabs/Sempro");
    if (!getResponse.ok) {
    ...
    const postResponse = await fetch("https://api.sheetbest.com/sheets/a4e0b8ce-db68-4e5f-b0ff-d22f47fe3a0f/tabs/Sempro", {
      method: "POST",
      headers: {
