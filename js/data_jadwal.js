...
async function fetchData() {
  ...
  try {
    const responseSempro = await fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Sempro?NPM=${user.NPM}`);
    ...
    const responseSemhas = await fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Semhas?NPM=${user.NPM}`);
