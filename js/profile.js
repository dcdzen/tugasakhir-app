...
function loadUserProfile() {
  ...
  fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Mahasiswa?NPM=${user.NPM}`)
  ...
  fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Praproposal?NPM=${user.NPM}`)
    .then((response) => response.json())
    .then((data) => {
  ...
  fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Sempro?NPM=${user.NPM}`)
    .then((response) => response.json())
    .then((data) => {
  ...
  fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Semhas?NPM=${user.NPM}`)
    .then((response) => response.json())
    .then((data) => {
...
//   try {
//     const response = await fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Sempro/NPM/${user.NPM}`, {
//       method: "DELETE",
//     });
    ...
    if (userDataMahasiswa) {
      ...
      document.getElementById("profile-edit-form").addEventListener("submit", async (event) => {
        ...
        try {
          ...
          const response = await fetch(`https://api.sheetbest.com/sheets/f4b8387c-6ddc-4485-b90b-6796d0b8fbf2/tabs/Mahasiswa/NPM/${user.NPM}`, {
            method: "PUT",
            headers: {
